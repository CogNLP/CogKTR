...
#
#     def forward(self, sent_vecs, concept_ids, node_type_ids, node_scores, adj_lengths, adj, metapath_fea,
#                 metapath_fea_count, emb_data=None,
#                 cache_output=False):
#         """
...
#                  n_concept=799273, concept_dim=32, concept_in_dim=1024, mp_fea_size=torch.Size([500,4,528,42]), n_attention_head=1,
...
#                                       concept_ids,
#                                       node_type_ids, node_scores, adj_lengths, adj, metapath_feature,
