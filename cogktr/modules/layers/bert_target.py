...
class BertTarget(nn.Module):
    ...
    def __init__(self, hidden_size, vocab_size):
        ...
        # MLM.
        self.mlm_linear_1 = nn.Linear(hidden_size, hidden_size)
        self.layer_norm = LayerNorm(hidden_size)
        self.mlm_linear_2 = nn.Linear(hidden_size, self.vocab_size)

        # NSP.
        self.nsp_linear_1 = nn.Linear(hidden_size, hidden_size)
        self.nsp_linear_2 = nn.Linear(hidden_size, 2)
    ...
    def mlm(self, memory_bank, tgt_mlm):
        ...
        output_mlm = self.gelu(self.mlm_linear_1(memory_bank))
