...
class Sst5Reader(BaseReader):
    def __init__(self, raw_data_path):
        super().__init__()
        self.raw_data_path = raw_data_path
        downloader = Downloader()
        downloader.download_sst5_raw_data(raw_data_path)
        self.train_file = 'sst_train.txt'
        self.dev_file = 'sst_dev.txt'
        self.test_file = 'sst_test.txt'
