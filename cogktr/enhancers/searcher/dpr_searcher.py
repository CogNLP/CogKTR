...
import numpy as np
from cogktr.enhancers.searcher.base_searcher import BaseSearcher
from collections import OrderedDict
import os
import faiss
import pickle
from cogktr.utils.io_utils import load_pickle
...
class DprSearcher(BaseSearcher):
    def __init__(self,model_file,index_path,wiki_passages):
        super(DprSearcher, self).__init__()
