...
from cogktr import init_cogktr, Conll2003Reader, Conll2003Processor
from cogktr import PlmAutoModel, BaseSequenceLabelingModel, BaseClassificationMetric, Trainer
...
model = BaseSequenceLabelingModel(plm=plm, vocab=vocab)
