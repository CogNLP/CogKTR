...
from cogktr.data.reader.commonsenseqa_reader import CommonsenseqaForSAFEReader
from cogktr.data.processor.commonsenseqa_processors.commonsenseqa_for_safe_processor import CommonsenseQAForSafeProcessor
...
device, output_path = init_cogktr(
    ...
    folder_tag="exp_commonsense_qa_safe",
)
...
enhancer = CommonsenseEnhancer(
    ...
    cache_path='/data/hongbang/CogKTR/datapath/question_answering/CommonsenseQA/',
...
processor = CommonsenseQAForSafeProcessor(plm="roberta-large", max_token_len=128, vocab=vocab,debug=False)
