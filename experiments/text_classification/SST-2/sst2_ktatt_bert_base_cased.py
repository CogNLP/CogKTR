...
from cogktr import Sst2Reader, WorldEnhancer, Sst2ForKtattProcessor, PlmBertModel, BaseTextClassificationModel, \
    BaseClassificationMetric, Trainer
...
kmodel = PlmBertModel(pretrained_model_name="bert-base-cased")
