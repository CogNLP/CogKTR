...
from cogktr import *
from cogktr.data.processor.sst5_processors.sst5_for_sembert_processor import Sst5ForSembertProcessor
...
device, output_path = init_cogktr(
    device_id=8,
    output_path="/data/hongbang/CogKTR/datapath/text_classification/SST_5/experimental_result",
    folder_tag="simple_test",
)

reader = Sst5Reader(raw_data_path="/data/hongbang/CogKTR/datapath/text_classification/SST_5/raw_data")
...
processor = Sst5ForSembertProcessor(plm="bert-base-cased", max_token_len=128, vocab=vocab,debug=False)
...
early_stopping = EarlyStopping(mode="max",patience=3,threshold=0.0001,threshold_mode="abs",metric_name="macro_F1")
