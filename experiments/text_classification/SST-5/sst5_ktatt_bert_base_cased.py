...
from cogktr import Sst5Reader, WorldEnhancer, Sst5ForKtattProcessor, PlmBertModel, BaseTextClassificationModel, BaseClassificationMetric, Trainer
from cogktr.utils.general_utils import init_cogktr

device, output_path = init_cogktr(
    device_id=3,
    output_path="/home/chenyuheng/zhouyuyang/CogKTR/datapath/text_classification/SST_5/experimental_result",
    folder_tag="experiment",
)

reader = Sst5Reader(raw_data_path="/home/chenyuheng/zhouyuyang/CogKTR/datapath/text_classification/SST_5/raw_data")
train_data, dev_data, test_data = reader.read_all()
vocab = reader.read_vocab()

enhancer = WorldEnhancer(knowledge_graph_path="/home/chenyuheng/zhouyuyang/CogKTR/datapath/knowledge_graph",
                         cache_path="/home/chenyuheng/zhouyuyang/CogKTR/datapath/text_classification/SST_5/enhanced_data",
