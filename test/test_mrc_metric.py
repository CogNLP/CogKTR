...
evaluator = Evaluator(
    ...
    # checkpoint_path="/data/hongbang/CogKTR/datapath/reading_comprehension/SQuAD2.0/experimental_result/mrc_baseline--2022-07-17--12-34-50.07/best_model/checkpoint-62000",
    dev_data=dev_dataset,
    metrics=metric,
    sampler=None,
    drop_last=False,
    collate_fn=processor._collate,
    file_name="mrc_model.pt",
    batch_size=32,
    device=device,
    user_tqdm=True,
)
